...
export default function App() {
  ...
  function Update(step, id) {
    if (step === 1) {
      //Deleting of items from the list of items
      let temp = itemArr;
      ...
      //decrementing the number of item
      ...
      <Container className="container">
        <div className="Items">
          ...
          <div style={{ float: "left", width: "62%" }}>
            <span style={{ float: "left" }}>Items ( {itemArr.length} )</span>
          </div>
          <span style={{ float: "left", marginLeft: "55px" }}> Qty</span>
          <span style={{ float: "right", width: "12%" }}> Price</span>
          <br />
          <hr />
          {itemArr.length ? (
            ""
          ...
          {itemArr.map((number, index) => (
            <div style={{ marginBottom: "10px" }} key={number[0]}>
              <div
                ...
                style={{ border: "solid grey 2.5px", borderRadius: "2px" }}
              >
                <img
        ...
        <div className="Bill">
          ...
          >
            <h3
              style={{ padding: "3px 25px", marginBottom: 0, display: "flex" }}
            >
              Total
            </h3>
            <div
